  ...
  db.serialize(function() {
    var createEventTable = function() {
      ...
      stmt.run({
          ...
          $start: (new Date(1994, 3, 21, 12, 0, 0, 0)).toLocaleString(),
      ...
      stmt.run({
          ...
          $start: (new Date(2016, 6, 7, 18, 30, 0, 0)).toLocaleString(),
          $end: (new Date(2016, 6, 11, 11, 15, 0, 0)).toLocaleString(),
          $cost: 50.0,
      ...
      stmt.run({
          ...
          $start: (new Date(2016, 9, 5, 16, 0, 0, 0)).toLocaleString(),
          $end: (new Date(2016, 9, 5, 20, 30, 0, 0)).toLocaleString(),
          $cost: 6.0,
      ...
      stmt.run({
          ...
          $start: (new Date(2016, 11, 25, 20, 0, 0, 0)).toLocaleString(),
          $end: (new Date(2016, 11, 25, 22, 30, 0, 0)).toLocaleString(),
          $cost: 10.0,
      ...
      stmt.run({
          ...
          $start: (new Date(2016, 11, 31, 22, 0, 0, 0)).toLocaleString(),
          $end: (new Date(2016, 11, 31, 23, 45, 0, 0)).toLocaleString(),
          $cost: 125.0,
